...
This is a list of questions that people regularly ask **about the guide**. These are **not** questions about learning Japanese, but rather about the AJATT Grammar Guide project.

### Why did you create this guide?

It is not a secret that AJATT Grammar Guide is almost entirely based on [sakubi](https://sakubi.neocities.org/).
Sakubi is an open project.
...
AJATT Grammar Guide as a project was started by [AJATT](https://ajatt.top/), and the project lives in the public on [github](https://github.com/Ajatt-Tools/grammar). However, the project itself is a community project open to discussion, feedback, and contributions from anyone. A lot of people have helped with ideas, fixes, suggestions, proofreading, testing, etc. If you want to join them too, you can file issues on github, or just join our [community](https://ajatt.top/blog/join-our-community.html).
...
### What does AJATT Grammar Guide mean?

It means a grammar guide that supports the [AJATT](https://ajatt.top/blog/whats-ajatt.html) philoshopy.

And just like that, AJATT Grammar Guide is the grammar guide for AJATTers.
